...
class Main {
    ...
    moneyFromRevenueToday(specDate){
        ...
        let costForRoom = todaysBookings.map(room => {
            ...
            roomCost: this.rooms.find(item => item.number === room.roomNumber).costPerNight
            }
        })
    ...
    bookingsSingleDayHighDate(){
        ...
        return Object.keys(roomCostAndDateArray).find(date => roomCostAndDateArray[date] === maxNumberOfRooms)
    }
    ...
    bookingsSingleDayLowDate(){
        ...
        return Object.keys(roomCostAndDateArray).find(date => roomCostAndDateArray[date] === minNumberOfRooms)
    }
    ...
    updateToDom(){
        ...
        domUpdates.displayTotalServiceChargesForToday(this.moneyFromServicesToday(this.date));
        domUpdates.displayRoomChargesRevenueForToday(this.moneyFromRevenueToday(this.date));
        domUpdates.displayPercentageOfRoomsBooked(this.percentageOfRoomsBooked(this.date));
        domUpdates.displayMostRoomsBookedInOneDay(this.bookingsSingleDayHigh(), this.bookingsSingleDayHighDate())
        domUpdates.displayLeastRoomsBookedInOneDay(this.bookingsSingleDayLow(), this.bookingsSingleDayLowDate())
